...
<body>
    <form method="post">
        ...
        <div class="input-group">
            ...
            <input <?php if(isset($erro_geral) or isset($erro_nome)){echo 'class="erro-input"';}?> name="nome_completo"
                type="text" placeholder="Nome Completo"
                <?php if(isset($_POST['nome_completo'])){ echo "value='".$_POST['nome_completo']."'";}?> required>
        ...
        <div class="input-group">
            ...
            <input <?php if(isset($erro_geral) or isset($erro_email)){echo 'class="erro-input"';}?> type="email"
        ...
        <div class="input-group">
            ...
            <input type="password"
                ...
                name="repete_senha" placeholder="Repita a senha criada"
        ...
        <div
            <?php if(isset($erro_geral) or isset($erro_checkbox)){echo 'class="input-group erro-input"';}else{echo 'class="input-group"';}?>>
